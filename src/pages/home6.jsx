        ...
        <div className="container">
          <div className="row">
              <div className="col-lg-12">
                  <div className="subtitle mb-3">Incredibly Achievements</div>
                  <h2 className="mb20"><span className="text-gradient">Prestigious</span> Accomplishments Section</h2>
              </div>
          </div>
        </div>
        <Section1/>
        ...
        <div className="container">
            <div className="row">
              <div className="col-md-6">
                  <div className="subtitle mb20">Revolutionary Breakthroughs </div>
                  <h2 className="wow fadeInUp"><span className="text-gradient">Visionary Excellence</span></h2>
                  <div className="spacer-20"></div>
              </div>
              <div className="col-lg-6 text-lg-end">
                  <Link className="btn-main mb-sm-30" to="/">Profile</Link>
              </div>
            </div>
            </div>
          <Collection/>
